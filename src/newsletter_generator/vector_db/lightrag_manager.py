...
def add_document(document_id: str, text: str, metadata: Optional[Dict[str, Any]] = None) -> None:
    """Add a document to the vector database.
...
def update_document(document_id: str, text: str, metadata: Optional[Dict[str, Any]] = None) -> None:
    """Update a document in the vector database.

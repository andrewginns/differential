...
def newsletter_assembler():
    ...
    with (
        ...
        patch("newsletter_generator.newsletter.assembler.os.makedirs") as _,
    ):
        ...
        mock_processor.generate_newsletter_section.return_value = (
...
class TestNewsletterAssembler:
    ...
    def test_organise_by_category_with_missing_categories(self, newsletter_assembler):
        ...
        content_items = [
            {"id": "content1", "text": "Test content 1", "metadata": {"title": "Test 1"}},
            {
                "id": "content2",
                "text": "Test content 2",
                "metadata": {"category": "Category B", "title": "Test 2"},
    ...
    def test_assemble_newsletter(self, mock_file, mock_datetime, newsletter_assembler):
        ...
        mock_now.strftime.side_effect = (
            lambda fmt: "2025-05-01" if fmt == "%Y-%m-%d" else "May 01, 2025"
        )
        mock_datetime.datetime.now.return_value = mock_now

        with (
            patch.object(newsletter_assembler, "collect_weekly_content") as mock_collect,
            ...
            assert (
                "*This newsletter was automatically generated on May 01, 2025.*" in written_content
            )
...
class TestConvenienceFunctions:
    ...
    def test_get_newsletter_assembler(self):
        ...
        with patch(
            "newsletter_generator.newsletter.assembler.NewsletterAssembler"
    ...
    def test_collect_weekly_content_function(self):
        ...
        with patch(
            "newsletter_generator.newsletter.assembler.get_newsletter_assembler"
    ...
    def test_generate_related_content_section_function(self):
        ...
        with patch(
            ...
            mock_assembler.generate_related_content_section.assert_called_once_with(
                content_id="content1", max_items=5
            )

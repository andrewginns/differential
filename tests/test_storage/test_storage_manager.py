...
class TestConvenienceFunctions:
    ...
    def test_write_content_function(self):
        ...
        with patch(
            "newsletter_generator.storage.storage_manager.storage_manager.write_content"
        ) as mock_write:
    ...
    def test_read_content_function(self):
        ...
        with patch(
            "newsletter_generator.storage.storage_manager.storage_manager.read_content"
        ) as mock_read:
    ...
    def test_update_metadata_function(self):
        ...
        with patch(
            "newsletter_generator.storage.storage_manager.storage_manager.update_metadata"
        ) as mock_update:
    ...
    def test_find_files_by_status_function(self):
        ...
        with patch(
            "newsletter_generator.storage.storage_manager.storage_manager.find_files_by_status"
        ) as mock_find:
    ...
    def test_cleanup_old_files_function(self):
        ...
        with patch(
            "newsletter_generator.storage.storage_manager.storage_manager.cleanup_old_files"
        ) as mock_cleanup:

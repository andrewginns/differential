...
class TestLightRAGManager:
    ...
    def test_init_creates_data_dir(self):
        ...
        with patch("newsletter_generator.vector_db.lightrag_manager.OpenAI"), \
             patch("newsletter_generator.vector_db.lightrag_manager.lightrag"):
            
            manager = LightRAGManager(data_dir=test_dir)
    ...
    def test_update_document(self, lightrag_manager):
        ...
        with patch.object(lightrag_manager, "delete_document") as mock_delete, \
            ...
            mock_add.assert_called_once_with(
                "test_id", "Updated text", {"key": "updated_value"}
            )
...
class TestConvenienceFunctions:
    ...
    def test_add_document_function(self):
        ...
        mock_db = MagicMock()
        with patch("newsletter_generator.vector_db.lightrag_manager.get_vector_db", return_value=mock_db):
            add_document(
                document_id="test_id",
                text="Test text",
                metadata={"key": "value"},
